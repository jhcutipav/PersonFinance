...
>>>>>>> fb8139b742db1f4632d0eb1c4474e7306b3a14cf
    ...
    { id: 6, nombre: 'BCP S/',            tipo: 'debito',    moneda: 'PEN', saldo: 0.0,     activo: true, color: 'blue',   icono: '🏦', bancarizado: true },
    { id: 7, nombre: 'YAPE BCP',          tipo: 'billetera', moneda: 'PEN', saldo: 0.0,     activo: true, color: 'purple', icono: '📱', bancarizado: true, cuentaVinculadaId: 6 },
    { id: 8, nombre: 'Prex',              tipo: 'billetera', moneda: 'PEN', saldo: 0.0,     activo: true, color: 'amber',  icono: '📱', bancarizado: false },
    { id: 9, nombre: 'Caja los Andes',    tipo: 'debito',    moneda: 'PEN', saldo: 0.0,     activo: true, color: 'amber',  icono: '🏦', bancarizado: true },
    { id: 10, nombre: 'Interbank TC',     tipo: 'credito',   moneda: 'PEN', saldo: 0.0,     activo: true, color: 'green',  icono: '💳', bancarizado: true },
